...
*********************************************************************
*/
__global__ void gpu_matrix_mult(int *a,int *b, int *c, int m)
{ 
...
{
    __shared__ int tile_a[blockDim][BLOCK_SIZE];
...
int main(int argc, char** argv)
{
    ...
    printf("Time elapsed on matrix multiplication of %dx%d . %dx%d on Sequential_GPU: %f ms.\n\n", m, m, m, m, seq_gpu_elapsed_time_ms);
